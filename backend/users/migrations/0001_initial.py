    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("employee_fio",
                 models.CharField(max_length=250, verbose_name="ФИО")),
                (
                    "email",
                    models.EmailField(
                        max_length=100,
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="users_gazpr_employe_102259_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="gazpromuser",
            index=models.Index(
                ...
                name="users_gazpr_employe_c82d51_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="gazpromuser",
            index=models.Index(
                ...
                name="users_gazpr_employe_e796c8_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="gazpromuser",
            index=models.Index(
                fields=["employee_grade"],
                name="users_gazpr_employe_64f9d1_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="gazpromuser",
            index=models.Index(
                fields=["employee_location"],
                name="users_gazpr_employe_3ad0bb_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="gazpromuser",
